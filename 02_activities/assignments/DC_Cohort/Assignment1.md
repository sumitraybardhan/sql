...
```
The WIRED article’s lesson is that large identity systems don’t merely record who we are; they also decide which relationships “count,” and those judgments are operationalized as database checks that grant or deny access to civic functions and rights. My parents immigrated to Canada in the early 70s, left for Nigeria for teaching opportunities, and we returned to Canada when I was four because of political turmoil under a military dictator and mass expulsions of foreigners. I have reflected on this life experience—which I believe is not unique among immigrants to Canada—amid ongoing discussion of policy and immigration amendments for the “Lost Canadians.”
“Lost Canadians” were individuals who lost or never received citizenship due to outdated rules tied to gender, marital status, place of birth, and naturalization status (see: https://www.canada.ca/en/immigration-refugees-citizenship/corporate/transparency/committees/soci-dec-5-2024/chronology-lost-canadians.html). Having grown up in Canada, I was not acutely aware of this term until adulthood and the recent legislative changes to restore or grant citizenship to these individuals. The issue was of significant interst to me due to the 2009 “first-generation limit” change: Canadians born outside Canada cannot automatically pass on citizenship to children born abroad. Essentially, someone like me—born in Nigeria to parents born in India, raised in Canada since age four—may only become aware of this rule when doing a routine transaction such as a passport renewal, and the system’s “rejection” reveals a policy we never realized applied to us. The result is a control that surfaces at the point of service, reminding us that identity is often mediated by what a schema can verify rather than more substantive definitions of civic rights and citizenship. While the “first-generation limit” was found unconstitutional (see https://www.canada.ca/en/immigration-refugees-citizenship/services/canadian-citizenship/proof-citizenship/application-first-generation.html) and legislative amendments introduced this week would allow residency definitions to define citizenship (see https://www.theglobeandmail.com/politics/article-mps-vote-lost-canadians-bill-conservative-changes/), the episode underscores how value systems are embedded in databases and data systems.
